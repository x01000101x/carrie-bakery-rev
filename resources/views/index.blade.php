        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="item active">
              <img src="{{ url('assets/images/produk/carriebakery.jpeg')}}" alt="Los Angeles" style="width:100%;">
            </div>

            <div class="item">
              <img src="{{ url('assets/images/produk/carriebakery.jpeg')}}" alt="Chicago" style="width:100%;">
            </div>

            <div class="item">
              <img src="{{ url('assets/images/produk/carriebakery.jpeg')}}" alt="New york" style="width:100%;">
            </div>
          </div>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div id="owl-example" class="owl-carousel">
                        ...
                        <div> <img class="partner-img" src="{{ Voyager::image($partner->gambar) }}" alt=""></div>
                        @endforeach
