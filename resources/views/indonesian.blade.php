					...
					<div class="product-grid">
						<ul>
							...
							<li>
								<div class="products">
									<a href="#">
										<img class="gambar" src="{{  Voyager::image($indo->produk_gambar)}}" alt="">
									</a>
									<a href="#">
										<h4>{{ $indo->produk_nama }}</h4>
									</a>
									<p class="price">@currency($indo->produk_harga) </p>
									<div>
										@if($indo->link_blass!=null)
										<a class="view-link shutter" href="{!! url($indo->link_blass) !!}">
											<i class="fa fa-plus-circle"></i>Order
										</a>
										@else
										<a class="view-link shutter" href="/order/{{ $indo->id }}">
