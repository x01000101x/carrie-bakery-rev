                            ...
                            <fieldset>
                                ...
                                <div class="form_content clearfix">
                                    <p class="text">
                                        ...
                                        <span><input placeholder="E-mail address" type="text" id="email"
                                                name="email" value="" class="account_input"></span>
                                    </p>
                                    <p class="text">
                                        <label for="passwd">Password</label>
                                        <span><input placeholder="Password" type="password" id="passwd"
    ...
    <header>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <a href="#">
                        <img class="carrie" src="{{ url('assets/images/produk/carriebakery.jpeg') }}"
                            alt="logo">
                    </a>
                ...
                <div class="col-md-4">
                    <div class="block clearfix">
                        <a href="#">
                            ...
                            <img class="footer-carrie" src="{{ url('assets/images/produk/carriebakery.jpeg') }}"
                                alt="">
