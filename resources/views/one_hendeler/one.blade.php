...
<body>
	...
	<section id="shop">
		@include('one_hendeler.one_bread')
	</section> <!-- End of Section -->
						...
						<div class="media">
							<div class="mapouter">
								<div class="gmap_canvas"><iframe width="600" height="200" id="gmap_canvas"
										src="https://maps.google.com/maps?q=pakuan%20hill%20cluster%20livistona&t=&z=13&ie=UTF8&iwloc=&output=embed"
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						...
						<p class="copyright-text pull-right">Carrie Bakery @2022 Designed by <a style="color: blue"
