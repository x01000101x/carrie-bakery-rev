					...
					<div class="product-grid">
						<ul>
							...
							<li>
								<div class="products">
									<a href="#">
										<img class="gambar" src="{{  Voyager::image($beverage->produk_gambar)}}" alt="">
									</a>
									<a href="#">
										<h4>{{ $beverage->produk_nama }}</h4>
									</a>
									<p class="price">@currency($beverage->produk_harga) </p>
									<div>
										@if($beverage->link_blass!=null)
										<a class="view-link shutter" href="{!! url($beverage->link_blass) !!}">
											<i class="fa fa-plus-circle"></i>Order
										</a>
										@else
										<a class="view-link shutter" href="/order/{{ $beverage->id }}">
